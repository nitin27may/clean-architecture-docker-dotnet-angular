...
{
    public OperationRepository(IDapperHelper dapperHelper) : base(dapperHelper, "Operations")
    {
    }
    ...
    public async Task<Operation> GetOperationById(Guid id, IDbTransaction? transaction = null)
    {
        ...
        return await _dapperHelper.Get<Operation>(@"SELECT * FROM ""Operations"" WHERE ""Id"" = @Id", parameters, CommandType.Text, transaction);
    }
    ...
    public async Task<Operation> AddOperation(Operation operation, IDbTransaction? transaction = null)
    {
        ...
        return await _dapperHelper.Insert<Operation>(@"
    ...
    public async Task<Operation> UpdateOperation(Operation operation, IDbTransaction? transaction = null)
    {
        ...
        return await _dapperHelper.Update<Operation>(@"
            UPDATE ""Operations"" 
            SET 
                ""Name"" = @Name,  
